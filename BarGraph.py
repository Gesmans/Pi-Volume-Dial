...
while True:
    ...
    lcd.cursor_pos = (0, 0) # Set the cursor position to the first row and first column of the LCD
    lcd.write_string(f"Volume: {int(volume * 100)}%") # Write the volume percentage to the LCD
